...
@interface WBModel : JSONModel


@property (nonatomic,strong)UserModel *user;

@property (nonatomic,strong)WBModel <Optional> *retweeted_status;
...
@property (nonatomic,copy)NSString<Optional> * thumbnail_pic;//缩略图片地址，没有时不返回此字段
@property (nonatomic,copy)NSString <Optional>* bmiddle_pic;//	中等尺寸图片地址，没有时不返回此字段
@property (nonatomic,copy)NSString <Optional>* original_pic;//原始图片地址，没有时不返回此字段
@property (nonatomic,strong)NSObject <Optional>*geo;//地理信息字段 详细
...
@property (nonatomic,strong)NSObject <Optional>*pic_ids;//	微博配图ID。多图时返回多图ID，用来拼接图片url。用返回字段thumbnail_pic的地址配上该返回字段的图片ID，即可得到多个图片url。
@property (nonatomic,strong)NSObject <Optional>* ad;//	微博流内的推广微博ID
